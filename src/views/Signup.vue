	...
	<div class="min-h-screen flex flex-col items-center justify-center bg-gray-100 py-10">
	  <div class="max-w-[600px] w-full bg-white shadow-sm rounded-sm p-8 flex flex-col gap-4">
		...
		<form @submit.prevent="handleRegister" class="flex flex-col gap-4">
		  ...
		  <input v-if="userType === 'person'" v-model="form.birthday" type="date" placeholder="Birthday" class="input" />
  
		  <input v-model="form.street" type="text" placeholder="Street" class="input" />
		  <div class="flex gap-2">
			<input v-model="form.number" type="text" placeholder="Number" class="input flex-1" />
			<input v-model="form.complement" type="text" placeholder="Complement" class="input flex-1" />
		  </div>
		  <input v-model="form.neighborhood" type="text" placeholder="Neighborhood" class="input" />
		  <input v-model="form.city" type="text" placeholder="City" class="input" />
		  <input v-model="form.zipCode" type="text" placeholder="Zip Code" class="input" />
		  <input v-model="form.state" type="text" placeholder="State" class="input" />
  
		  <div class="flex gap-2">
			<input v-model="form.areaCode" type="text" placeholder="Area Code" class="input w-1/5 max-w-1/5" />
			<input v-model="form.phoneNumber" type="text" placeholder="Phone Number" class="input" />
		  </div>
